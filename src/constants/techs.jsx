...
import tailwindIcon from "../assets/Icon/Tech/tailwindCSS.svg"
...
const techs = [
    ...
    },
    {
      ...
      icon: tailwindIcon,
      detail:
        "A utility-first framework that lets you build modern, responsive designs quickly by applying pre-built classes.",
    },
  ];
